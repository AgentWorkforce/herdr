...
export const DEFAULT_ROOM_OPERATIONS = Object.freeze({
  ...
  'integration.adopt': relayfile([['integration', 'adopt']]),
  'integration.set-metadata': relayfile([['integration', 'set-metadata']]),
  'integration.resolve-path': relayfile([['integration', 'resolve-path']], { json: true }),
